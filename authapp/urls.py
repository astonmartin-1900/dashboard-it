...
from .views import edit, dashboard, wor_dates_generator, register, wor_calendar_generation, agenda, settings
...
urlpatterns = [
    ...
    path('wor-dates-generator/', wor_dates_generator, name='wor_dates_generator'),
